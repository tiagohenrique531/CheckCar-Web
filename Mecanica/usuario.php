        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                echo "<tr>
                        ...
                        <td>".$row['estado']."</td>
                        <td>
                            <a href='./actions/editar_usuario.php?id=".$row['id']."' class='btn-editar'>Editar</a>
                            <a href='./actions/excluir_usuario.php?id=".$row['id']."' class='btn-excluir' onclick=\"return confirm('Deseja realmente excluir este usuário?');\"><i class='fa fa-trash'></i></a>
